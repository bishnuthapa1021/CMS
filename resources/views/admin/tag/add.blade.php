...
@section('site_title')Tags @endsection
@section('content')
        ...
        <div class="float-right d-none d-md-block">
            <div class="dropdown">
                <a href="{{route('tag.index')}}" class="btn btn-primary">
                    <i class="mdi mdi-eye mr-2"></i> View All Tag
                </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="form-group mb-4">
                                    ...
                                    <input id="tag_name" class="form-control" name="tag_name">

                                </div>

                            </div>
                            <input type="checkbox" id="switch3" name ="status" value="1" switch="bool" checked/>
